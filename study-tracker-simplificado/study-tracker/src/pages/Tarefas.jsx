...
// Estilos das prioridades das tarefas
const prioStyles = {
...
export default function Tarefas() {
  ...
  // --- TELA DE CARREGAMENTO ANIMADO (IGUAL AO DASHBOARD) ---
  if (isLoading) {
    return (
      ...
      >
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-1.5">
            ...
            <Input value={form.subject} onChange={(e) => setForm({...form, subject: e.target.value})} placeholder="Ex: Redes de Computadores" className="rounded-xl h-11" />
          </div>
